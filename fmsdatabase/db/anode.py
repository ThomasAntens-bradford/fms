...
from ..utils.general_utils import FRStatus
...
class AnodeFR(Base):
    """
    ---------------------------------
    Anode Flow Restrictor Table 1.7.2
    ---------------------------------
    ...
    certification = relationship("FRCertification", back_populates="anode_fr")
    manifold = relationship("ManifoldStatus", back_populates="anode")
